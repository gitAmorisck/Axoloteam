...
opn.style.height = "330px";
var tex = document.getElementById("tex");
tex.style.left = "15px";
tex.style.width = "150px"
var a = document.getElementById("jmk");
a.innerHTML = "<h2>←</h2>";
...
f.style.left = "0%";
var ml = document.getElementById("vv1");
ml.style.left = "0px";
ml.style.width = "150px";
var ml2 = document.getElementById("vv2");
ml2.style.width = "150px";
a.className = "1";}
else {
var opn = document.getElementById("opn");
opn.style.height = "300px";
var tex = document.getElementById("tex");
tex.style.left = "25px";
tex.style.width = "200px"
var ml = document.getElementById("vv1");
ml.style.left = "0px";
ml.style.width = "150px";
var ml2 = document.getElementById("vv2");
...
kp6.style.width = sz;
kp7.style.width = sz;
kp8.style.width = "120px";
kp9.style.width = "120px";
if (b == "0") {
var a = document.getElementById("jmk");
a.innerHTML = "<h2>←</h2>";
var e = document.getElementsByTagName("body")[0];
